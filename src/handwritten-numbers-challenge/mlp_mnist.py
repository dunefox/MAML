...
# one hidden layer with 36 neurons, learning rate = 2.5, quadratic loss
# init weights and biases according to normal distribution with adapted variance
